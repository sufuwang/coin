...
class SimulatedExchange:
    ...
    def calculate_total_balance_and_roi(self, current_prices: dict):
        ...
        for symbol, positions in self.positions.items():
            ...
            for pos in positions:
                ...
                position_value = pos['size'] * price / leverage
    ...
    def open_position(self, symbol, direction, entry_price, take_profit, stop_loss, position_size, timestamp, leverage):
    ...
    def process_closing(self, symbol, kline, signal):
        ...
        # **解包信号**
        _, _, _, _, exit_flag, _ = signal  # 只关心 exit_flag 是否需要平仓
    ...
    def process_opening(self, symbol, kline, signal):
        ...
        if len(signal) == 5:
            ...
            leverage = self.leverage  # 默认使用全局
        else:
            direction, tp, sl, plan_size, _, leverage = signal
        ...
        if final_pos_size > 0:
            self.open_position(symbol, direction, current_close, tp, sl, plan_size, timestamp, leverage)